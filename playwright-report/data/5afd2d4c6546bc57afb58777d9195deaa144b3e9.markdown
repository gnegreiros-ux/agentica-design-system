...
- generic [active] [ref=e1]:
  ...
  - generic [ref=e30]:
    ...
    - main [ref=e129]:
      - generic [ref=e130]:
        - generic [ref=e131]:
          - code [ref=e132]: ADR-087
          - status [ref=e134]:
            - generic [ref=e135]: Active
          - generic [ref=e136]: contract
        - 'heading "`agtc-top-nav` confirmed as \"mix\" architecture, dead mobile-menu code removed" [level=1] [ref=e137]'
        - generic [ref=e138]:
          - generic [ref=e139]:
            - term [ref=e140]: Date
      ...
      - paragraph [ref=e158]:
        ...
        - text: "'s embedded"
        - code [ref=e160]: site.js
        - text: had a fully dead code block —
      - generic [ref=e161]:
        - code [ref=e162]: "const menuToggle = document.querySelector('.menu-toggle'); const topNav = document.querySelector('agtc-top-nav'); if (menuToggle && topNav) { /* … */ }"
        - generic [ref=e163]: js
        - button "Copy code (js)" [ref=e164] [cursor=pointer]: Copy
      - paragraph [ref=e165]:
        - text: Neither selector ever matches anything in the generated HTML (the real mobile-menu button is
        - code [ref=e166]: <button class="menu-btn" data-menu-toggle>
        - text: ", not"
        - code [ref=e167]: .menu-toggle
        - text: ), so this
        - code [ref=e168]: if
        - text: never ran. The site's actual mobile menu has worked all along through a separate, already-correct mechanism (
        - code [ref=e169]: "[data-menu-toggle]"
        - text: /
        - code [ref=e170]: "[data-main-nav]"
      ...
      - paragraph [ref=e172]:
        ...
        - strong [ref=e183]:
          - text: The dead
          - code [ref=e184]: agtc-top-nav
          - text: /
          - code [ref=e185]: .menu-toggle
          - text: mobile-menu block removed
        - text: from
        - code [ref=e186]: site/build.js
        - text: . The real mobile menu (
        - code [ref=e187]: "[data-menu-toggle]"
        - text: /
        - code [ref=e188]: "[data-main-nav]"
      ...
      - table [ref=e191]:
        - rowgroup [ref=e192]:
          - row "Alternative Reason for rejection" [ref=e193]:
            - columnheader "Alternative" [ref=e194]
            - columnheader "Reason for rejection" [ref=e195]
        - rowgroup [ref=e196]:
          ...
          - row "Leave the smoke-test check failing / delete it outright It was catching a real (if misdiagnosed) drift risk — the site's nav display property regressing silently; better to point it at the actual markup than remove coverage" [ref=e203]:
            - cell "Leave the smoke-test check failing / delete it outright" [ref=e204]
            - cell "It was catching a real (if misdiagnosed) drift risk — the site's nav display property regressing silently; better to point it at the actual markup than remove coverage" [ref=e205]
      - heading "Consequences" [level=2] [ref=e206]
      - list [ref=e207]:
        - listitem [ref=e208]:
          - code [ref=e209]: npm run smoke
          - text: ": 7/7 checks pass again."
        - listitem [ref=e210]:
          - text: No visual or functional change to the live site —
          - code [ref=e211]: .site-nav
          - text: markup and the working mobile
      - paragraph [ref=e212]: menu are untouched; only dead code was removed.
      - list [ref=e213]:
        - listitem [ref=e214]: "GitHub Projects: the linked ticket moved to Terminé."
        - listitem [ref=e215]:
          - text: Any future decision to actually mount
          - code [ref=e216]: <agtc-top-nav>
          - text: on the site (full dogfooding, per
      - paragraph [ref=e217]:
        - code [ref=e218]: project_site_as_lab
      ...
      - generic [ref=e219]:
        - link "← ADR-086" [ref=e220] [cursor=pointer]:
          - /url: adr-086.html
        - link "ADR-088 →" [ref=e221] [cursor=pointer]:
          - /url: adr-088.html
    - navigation "Table of contents / Table des matières" [ref=e222]:
      - generic [ref=e223]: On this page
      - link "Context" [ref=e224] [cursor=pointer]:
        - /url: "#context"
      - link "Decision" [ref=e225] [cursor=pointer]:
        - /url: "#decision"
      - link "Rejected alternatives" [ref=e226] [cursor=pointer]:
        - /url: "#rejected-alternatives"
      - link "Consequences" [ref=e227] [cursor=pointer]:
        - /url: "#consequences"
  - contentinfo [ref=e228]:
    - generic [ref=e229]:
      - generic [ref=e230]:
        - link "Agentica — Accueil" [ref=e231] [cursor=pointer]:
          - /url: ../index.html
          - img [ref=e232]
        - link "Guilherme Negreiros" [ref=e233] [cursor=pointer]:
          - /url: https://www.linkedin.com/in/gnegreiros/
          - img [ref=e234]
          - text: Guilherme Negreiros
      - generic [ref=e238]:
        - generic [ref=e239]: Navigation
        - link "Home" [ref=e240] [cursor=pointer]:
          - /url: ../index.html
        - link "Why" [ref=e241] [cursor=pointer]:
          - /url: ../pourquoi.html
        - link "Architecture" [ref=e242] [cursor=pointer]:
          - /url: ../architecture.html
        - link "Quality" [ref=e243] [cursor=pointer]:
          - /url: ../qualite.html
        - link "AI" [ref=e244] [cursor=pointer]:
          - /url: ../ia.html
      - generic [ref=e245]:
        - generic [ref=e246]: Documentation
        - link "Understand" [ref=e247] [cursor=pointer]:
          - /url: ../pourquoi.html
        - link "Get started" [ref=e248] [cursor=pointer]:
          - /url: ../get-started.html
        - link "Foundations" [ref=e249] [cursor=pointer]:
          - /url: ../foundations/index.html
        - link "Components" [ref=e250] [cursor=pointer]:
          - /url: ../components/index.html
        - link "Tokens" [ref=e251] [cursor=pointer]:
          - /url: ../tokens/index.html
        - link "Decisions" [ref=e252] [cursor=pointer]:
          - /url: ../decisions/index.html
        - link "Continuity" [ref=e253] [cursor=pointer]:
          - /url: ../continuite.html
        - link "Changelog" [ref=e254] [cursor=pointer]:
          - /url: ../changelog.html
      - generic [ref=e255]:
        - generic [ref=e256]: Explorer
        - link "Figma library" [ref=e257] [cursor=pointer]:
          - /url: ../resources.html
        - link "Storybook" [ref=e258] [cursor=pointer]:
          - /url: https://main--6a1c1e665ec5fe8fc0540983.chromatic.com/
        - link "GitHub" [ref=e259] [cursor=pointer]:
          - /url: https://github.com/gnegreiros-ux/agentica-design-system
        - link "Audit" [ref=e260] [cursor=pointer]:
          - /url: ../audit.html
        - link "AI Brief" [ref=e261] [cursor=pointer]:
          - /url: ../ai-brief.html
    - generic [ref=e262]:
      - generic [ref=e263]: © 2026 Guilherme Negreiros
      - generic [ref=e264]: Built with Claude Code.
  - button "Retour en haut" [ref=e265] [cursor=pointer]:
    - img [ref=e266]
    - generic [ref=e268]: Top
  - status [ref=e269]
```
