...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 1280px by 3694px, received 1280px by 3658px. 70871 pixels (ratio 0.02 of all image pixels) are different.
    ...
    - main [ref=e57]:
      ...
      - blockquote [ref=e195]:
        - paragraph [ref=e196]:
          ...
          - text: workflow (see
          - code [ref=e198]: governance/rules/ux-patterns-sources.md
    ...
    - generic [ref=e280]:
      ...
      - generic [ref=e305]:
        ...
        - link "Audit" [ref=e310] [cursor=pointer]:
          - /url: ../audit.html
        - link "Changelog" [ref=e311] [cursor=pointer]:
          - /url: ../changelog.html
