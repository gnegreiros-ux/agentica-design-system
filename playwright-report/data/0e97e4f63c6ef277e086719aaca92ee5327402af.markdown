...
- generic [active] [ref=e1]:
  ...
  - generic [ref=e30]:
    ...
    - main [ref=e129]:
      - generic [ref=e130]:
        - generic [ref=e131]:
          - code [ref=e132]: ADR-082
          - status [ref=e134]:
            - generic [ref=e135]: Active
        - heading "Brand/logo separated into a dedicated Figma library file (amends ADR-080)" [level=1] [ref=e136]
        - generic [ref=e137]:
          - generic [ref=e138]:
            - term [ref=e139]: Date
      ...
      - paragraph [ref=e145]:
        ...
        - code [ref=e146]: FOUNDATIONS > logos
      ...
      - paragraph [ref=e147]: "This has now been executed, not just discussed:"
      - list [ref=e148]:
        - listitem [ref=e149]:
          - text: The
          - code [ref=e150]: ↳ logos
      ...
      - paragraph [ref=e153]:
        ...
        - strong [ref=e155]:
          - code [ref=e156]: Agentica | Brand
        - text: (file key
        - code [ref=e157]: F8jhyCeRJaJhF7W1inlFuc
        - text: ), confirmed live via the Figma MCP connector.
      - list [ref=e158]:
        - listitem [ref=e159]: The move is permanent, with no back-reference left in the main file.
        - listitem [ref=e160]:
          - code [ref=e161]: Agentica | Brand
          - text: has been published as a Figma library and is consumed by the
      - paragraph [ref=e162]:
        - text: main file (
        - code [ref=e163]: Agentica — Agentic design system
        - text: ", file key"
        - code [ref=e164]: uXgPVB6cMLwAPqSwoa0dGq
      ...
      - paragraph [ref=e168]: change.
      - heading "Decision" [level=2] [ref=e169]
      - paragraph [ref=e170]:
        - strong [ref=e171]: "Amends ADR-080 Rule 1:"
        - code [ref=e172]: FOUNDATIONS > logos
      ...
      - paragraph [ref=e174]:
        - strong [ref=e175]: ADR-080 Rule 2 (pre-publication nested-instance audit) is reaffirmed and now concretely in scope
        - text: ", not merely a future contingency: because"
        - code [ref=e176]: Agentica | Brand
      ...
      - paragraph [ref=e178]:
        - code [ref=e179]: tokens/figma-text-styles.json
      ...
      - heading "Rejected alternatives" [level=2] [ref=e180]
      - paragraph [ref=e181]: "See ADR-080's \"Discussion en cours\" section for the alternative actually considered at the time (keep the logo page in the main file, rely solely on the Rule 1 page-exclusion list at each publish) — rejected there already, for the reasons recorded in that ADR: a manually-excluded page is one more thing to remember at every future publish, where a structural file boundary removes the need to remember it at all for the page-level case."
      - heading "Consequences" [level=2] [ref=e182]
      - list [ref=e183]:
        - listitem [ref=e184]:
          - code [ref=e185]: .claude/rules/figma-library-governance.md
          - text: "'s Community File content triage section"
      - paragraph [ref=e186]:
        - text: (added under ADR-080) is updated to drop
        - code [ref=e187]: FOUNDATIONS > logos
        - text: from the exclusion table and record the new
        - code [ref=e188]: Agentica | Brand
        - text: file key alongside the main file's.
      - list [ref=e189]:
        - listitem [ref=e190]: "The GitHub Projects \"Séparer les composants Brand/logo dans un fichier Figma dédié\" ticket (P2) moves to Terminé (the board's Status field is French: Backlog/En cours/Terminé/etc.)."
        - listitem [ref=e191]: Before the Community File is ever actually published, ADR-080's Rule 2 audit must
      - paragraph [ref=e192]: still be run in full against whatever components/patterns exist by then — this ADR does not shrink that audit's scope, only the Rule 1 page list.
      - list [ref=e193]:
        - listitem [ref=e194]: "Separately (not part of this decision, flagged for follow-up): while verifying this"
      - paragraph [ref=e195]:
        - text: change,
        - code [ref=e196]: get_metadata
        - text: without a
        - code [ref=e197]: nodeId
      ...
      - generic [ref=e198]:
        - link "← ADR-081" [ref=e199] [cursor=pointer]:
          - /url: adr-081.html
        - link "ADR-083 →" [ref=e200] [cursor=pointer]:
          - /url: adr-083.html
    - navigation "Table of contents / Table des matières" [ref=e201]:
      - generic [ref=e202]: On this page
      - link "Context" [ref=e203] [cursor=pointer]:
        - /url: "#context"
      - link "Decision" [ref=e204] [cursor=pointer]:
        - /url: "#decision"
      - link "Rejected alternatives" [ref=e205] [cursor=pointer]:
        - /url: "#rejected-alternatives"
      - link "Consequences" [ref=e206] [cursor=pointer]:
        - /url: "#consequences"
  - contentinfo [ref=e207]:
    - generic [ref=e208]:
      - generic [ref=e209]:
        - link "Agentica — Accueil" [ref=e210] [cursor=pointer]:
          - /url: ../index.html
          - img [ref=e211]
        - link "Guilherme Negreiros" [ref=e212] [cursor=pointer]:
          - /url: https://www.linkedin.com/in/gnegreiros/
          - img [ref=e213]
          - text: Guilherme Negreiros
      - generic [ref=e217]:
        - generic [ref=e218]: Navigation
        - link "Home" [ref=e219] [cursor=pointer]:
          - /url: ../index.html
        - link "Why" [ref=e220] [cursor=pointer]:
          - /url: ../pourquoi.html
        - link "Architecture" [ref=e221] [cursor=pointer]:
          - /url: ../architecture.html
        - link "Quality" [ref=e222] [cursor=pointer]:
          - /url: ../qualite.html
        - link "AI" [ref=e223] [cursor=pointer]:
          - /url: ../ia.html
      - generic [ref=e224]:
        - generic [ref=e225]: Documentation
        - link "Understand" [ref=e226] [cursor=pointer]:
          - /url: ../pourquoi.html
        - link "Get started" [ref=e227] [cursor=pointer]:
          - /url: ../get-started.html
        - link "Foundations" [ref=e228] [cursor=pointer]:
          - /url: ../foundations/index.html
        - link "Components" [ref=e229] [cursor=pointer]:
          - /url: ../components/index.html
        - link "Tokens" [ref=e230] [cursor=pointer]:
          - /url: ../tokens/index.html
        - link "Decisions" [ref=e231] [cursor=pointer]:
          - /url: ../decisions/index.html
        - link "Continuity" [ref=e232] [cursor=pointer]:
          - /url: ../continuite.html
        - link "Changelog" [ref=e233] [cursor=pointer]:
          - /url: ../changelog.html
      - generic [ref=e234]:
        - generic [ref=e235]: Explorer
        - link "Figma library" [ref=e236] [cursor=pointer]:
          - /url: ../resources.html
        - link "Storybook" [ref=e237] [cursor=pointer]:
          - /url: https://main--6a1c1e665ec5fe8fc0540983.chromatic.com/
        - link "GitHub" [ref=e238] [cursor=pointer]:
          - /url: https://github.com/gnegreiros-ux/agentica-design-system
        - link "Audit" [ref=e239] [cursor=pointer]:
          - /url: ../audit.html
        - link "AI Brief" [ref=e240] [cursor=pointer]:
          - /url: ../ai-brief.html
    - generic [ref=e241]:
      - generic [ref=e242]: © 2026 Guilherme Negreiros
      - generic [ref=e243]: Built with Claude Code.
  - button "Retour en haut" [ref=e244] [cursor=pointer]:
    - img [ref=e245]
    - generic [ref=e247]: Top
  - status [ref=e248]
```
