...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 1280px by 7887px, received 1280px by 7917px. 1767 pixels (ratio 0.01 of all image pixels) are different.
    ...
    - generic [ref=e157]:
      ...
      - generic [ref=e183]:
        ...
        - link "Audit" [ref=e187] [cursor=pointer]:
          - /url: audit.html
        - link "Brief IA" [ref=e188] [cursor=pointer]:
          - /url: ai-brief.html
    - generic [ref=e189]:
