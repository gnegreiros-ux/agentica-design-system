...
- generic [active] [ref=e1]:
  ...
  - generic [ref=e30]:
    ...
    - main [ref=e129]:
      - generic [ref=e130]:
        - generic [ref=e131]:
          - code [ref=e132]: ADR-088
          - status [ref=e134]:
            - generic [ref=e135]: Active
          - generic [ref=e136]: contract
        - heading "Agentica logo colors formalized (retroactive)" [level=1] [ref=e137]
        - generic [ref=e138]:
          - generic [ref=e139]:
            - term [ref=e140]: Date
      ...
      - paragraph [ref=e146]:
        - code [ref=e147]: scripts/validate-contracts.js
        - text: (ADR-086) flags
        - code [ref=e148]: semantic.color.brand.logo-black
        - text: and
        - code [ref=e149]: semantic.color.brand.logo-gray
        - text: as citing
        - code [ref=e150]: "\"decision\": \"logo-identity\""
        - text: — a value that doesn't match the
        - code [ref=e151]: ADR-XXX
        - text: shape every other
        - code [ref=e152]: decision
        - text: field in the token system uses.
      - paragraph [ref=e153]:
        - text: "Investigation found this wasn't a stand-in for an existing ADR:"
        - strong [ref=e154]: no ADR ever formally established the logo colors.
        - text: ADR-024 defines the brand *palette* (Teal/Rose/Bordeaux) but does not mention the logo's black (
        - code [ref=e155]: "#000000"
        - text: ) / gray (
        - code [ref=e156]: "#6B7280"
        - text: ) values at all. Per
        - code [ref=e157]: .claude/skills/pipelines/adr-triggers.md
      ...
      - paragraph [ref=e158]:
        - code [ref=e159]: tokens/primitives.json
        - text: "'s own"
        - code [ref=e160]: primitive.color.brand._readme
        ...
        - code [ref=e161]: "#000000"
        - text: and
        - code [ref=e162]: "#6B7280"
      ...
      - paragraph [ref=e164]:
        - text: "1."
        - strong [ref=e165]:
          - code [ref=e166]: primitive.color.brand.black
          - text: (
          - code [ref=e167]: "#000000"
          - text: ) and
          - code [ref=e168]: primitive.color.brand.gray
          - text: (
        ...
        - code [ref=e172]: _readme
        - text: note. 2.
        - strong [ref=e173]:
          - code [ref=e174]: semantic.color.brand.logo-black
          - text: /
          - code [ref=e175]: logo-gray
        - text: are the semantic layer over them, reserved for logo/wordmark/brand-icon use only (
        - code [ref=e176]: doNotUse
        - text: ": regular text, page background, any generic UI component — already encoded in"
        - code [ref=e177]: $extensions.doNotUse
        - text: ", unchanged by this ADR). 3."
        - strong [ref=e178]:
          - code [ref=e179]: tokens/semantic.json
          - text: "'s"
          - code [ref=e180]: decision
          - text: field for both tokens is updated from
          - code [ref=e181]: "\"logo-identity\""
          - text: to
          - code [ref=e182]: "\"ADR-088\""
        - text: ", resolving the"
        - code [ref=e183]: validate-contracts.js
      ...
      - table [ref=e187]:
        ...
        - rowgroup [ref=e192]:
          - 'row "Leave \"decision\": \"logo-identity\" as a documented, permanent exception to the ADR-shaped convention Would mean this project''s own trigger matrix (\"new color → ADR required\") doesn''t actually apply to every color — better to close the real gap than carve out an exception for it" [ref=e193]':
            - 'cell "Leave \"decision\": \"logo-identity\" as a documented, permanent exception to the ADR-shaped convention" [ref=e194]':
              - text: Leave
              - code [ref=e195]: "\"decision\": \"logo-identity\""
              - text: as a documented, permanent exception to the ADR-shaped convention
            - cell "Would mean this project's own trigger matrix (\"new color → ADR required\") doesn't actually apply to every color — better to close the real gap than carve out an exception for it" [ref=e196]
          - row "Fold this into ADR-024 (amend the brand palette ADR) ADR-024 is ✅ Active and, per decisions/README.md's own rule, \"immutable once active — any modification = a new ADR\"; amending it would violate that rule" [ref=e197]:
            - cell "Fold this into ADR-024 (amend the brand palette ADR)" [ref=e198]
            - cell "ADR-024 is ✅ Active and, per decisions/README.md's own rule, \"immutable once active — any modification = a new ADR\"; amending it would violate that rule" [ref=e199]:
              - text: ADR-024 is
              - code [ref=e200]: ✅ Active
              - text: and, per
              - code [ref=e201]: decisions/README.md
      ...
      - list [ref=e203]:
        - listitem [ref=e204]:
          - code [ref=e205]: tokens/semantic.json
          - text: ":"
          - code [ref=e206]: decision
          - text: field on both tokens now reads
          - code [ref=e207]: "\"ADR-088\""
          - text: .
        - listitem [ref=e208]:
          - code [ref=e209]: npm run validate:contracts
          - text: "(once merged with PR #46/ADR-086): the"
          - code [ref=e210]: logo-identity
          - text: warning
      - paragraph [ref=e211]:
        - text: disappears — every
        - code [ref=e212]: decision
        - text: field is now ADR-shaped and resolves to a real file.
      - list [ref=e213]:
        - listitem [ref=e214]:
          - text: No value, alias, or
          - code [ref=e215]: $extensions.doNotUse
          - text: change — this ADR documents an existing, already
      - paragraph [ref=e216]: correctly-enforced constraint, it does not alter it.
      - list [ref=e217]:
        - listitem [ref=e218]: "GitHub Projects: the linked ticket moved to Terminé."
      - generic [ref=e219]:
        - link "← ADR-087" [ref=e220] [cursor=pointer]:
          - /url: adr-087.html
        - link "ADR-089 →" [ref=e221] [cursor=pointer]:
          - /url: adr-089.html
