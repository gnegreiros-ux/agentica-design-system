...
- generic [active] [ref=e1]:
  ...
  - generic [ref=e30]:
    ...
    - main [ref=e129]:
      - generic [ref=e130]:
        - generic [ref=e131]:
          - code [ref=e132]: ADR-086
          - status [ref=e134]:
            - generic [ref=e135]: Active
          - generic [ref=e136]: contract
        - heading "Relationships registry and contract validation scripts (concepts borrowed from DSDS)" [level=1] [ref=e137]
        - generic [ref=e138]:
          - generic [ref=e139]:
            - term [ref=e140]: Date
      ...
      - paragraph [ref=e146]:
        ...
        - link "Design System Documentation Schema (DSDS)" [ref=e147] [cursor=pointer]:
      ...
      - paragraph [ref=e148]: "That analysis did surface two concepts worth borrowing on their own terms, without adopting DSDS's format:"
      - paragraph [ref=e149]:
        - text: "1."
        - strong [ref=e150]:
          - text: Typed
          - code [ref=e151]: relationships
        - text: "between entities (DSDS:"
        - code [ref=e152]: depends-on
        - text: ","
        - code [ref=e153]: composes
        - text: ","
        - code [ref=e154]: extends
        - text: ", …) — this repo already encodes relations, but scattered across three places that were never linked: token"
        - code [ref=e155]: $extensions["com.agentica.usage"].decision
        - text: /
        - code [ref=e156]: .doNotUse
        - text: /
        - code [ref=e157]: $metadata.contract
        - text: fields, token
        - code [ref=e158]: $value
        - text: aliases (
        - code [ref=e159]: "{semantic.color.action.primary}"
        - text: ), and the free-prose
        - code [ref=e160]: <strong>Relations:</strong>
        - text: header on every
        - code [ref=e161]: guidelines/
        - text: and
        - code [ref=e162]: .claude/rules/
        - text: file. There was no way to ask "what depends on this token?" without a repo-wide grep. 2.
        - strong [ref=e163]: Programmatic (deterministic) validation
        - text: of the documentation layer, as a complement to the qualitative, agent-driven pipelines in
        - code [ref=e164]: .claude/skills/pipelines/
        - text: .
      - heading "Decision" [level=2] [ref=e165]
      - paragraph [ref=e166]:
        - text: "1."
        - strong [ref=e167]:
          - code [ref=e168]: scripts/extract-relationships.js
        - text: walks the existing sources above and writes a single generated index (
        - code [ref=e169]: relationships-report.json
        - text: ", gitignored, run via"
        - code [ref=e170]: npm run relationships
        - text: ), with edges typed
        - code [ref=e171]: depends-on
        - text: ","
        - code [ref=e172]: excludes
        - text: ","
        - code [ref=e173]: governed-by
        - text: ","
        - code [ref=e174]: documented-in
        - text: ", and a looser"
        - code [ref=e175]: related
        - text: type for the free-prose header case.
        - code [ref=e176]: excludes
        - text: is an Agentica-specific addition (e.g.
        - code [ref=e177]: button.primary
        - text: ↔
        - code [ref=e178]: button.critical
        - text: mutual exclusion) — DSDS has no equivalent. 2.
        - strong [ref=e179]:
          - code [ref=e180]: scripts/validate-contracts.js
        - text: adds deterministic checks for the governance layer, deliberately scoped to NOT duplicate
        - code [ref=e181]: scripts/audit-tokens.js
        ...
        - code [ref=e182]: $extensions.decision
        - text: → a real file in
        - code [ref=e183]: decisions/
        - text: ), contract path integrity (
        - code [ref=e184]: $metadata.contract
        - text: → a real guideline file), token/guideline sync (a
        - code [ref=e185]: component.*
        - text: reference in a guideline still exists in
        - code [ref=e186]: tokens/component.json
        - text: ), and presence of the
        - code [ref=e187]: "## UX Patterns Reference"
        - text: section mandated by
        - code [ref=e188]: .claude/rules/ux-patterns-sources.md
        - text: . Wired into
        - code [ref=e189]: npm test
        - text: via
        - code [ref=e190]: npm run validate:contracts
        - text: . 3.
        - strong [ref=e191]:
          - code [ref=e192]: scripts/lib/contracts.js
      ...
      - heading "Credits" [level=3] [ref=e198]
      - paragraph [ref=e199]:
        ...
        - strong [ref=e200]: PJ Onori
        - text: (maintainer),
        - strong [ref=e201]: Afyia Smith
        - text: (governance and
        - code [ref=e202]: docOrigin
        - text: metadata schemas, introduced in v0.12.1),
        - strong [ref=e203]: Suleiman Ali Shakir
      ...
      - heading "Rejected alternatives" [level=2] [ref=e204]
      - table [ref=e206]:
        - rowgroup [ref=e207]:
          - row "Alternative Reason for rejection" [ref=e208]:
            - columnheader "Alternative" [ref=e209]
            - columnheader "Reason for rejection" [ref=e210]
        - rowgroup [ref=e211]:
          - row "Migrate documentation to the DSDS JSON format Pre-1.0 draft spec, no third-party tooling consumes it, no entity for ADRs (this repo's governance core) — see the prior comparative analysis" [ref=e212]:
            - cell "Migrate documentation to the DSDS JSON format" [ref=e213]
            - cell "Pre-1.0 draft spec, no third-party tooling consumes it, no entity for ADRs (this repo's governance core) — see the prior comparative analysis" [ref=e214]
          - row "Validate tokens/*.json against DTCG's official JSON Schema via ajv Adds a new runtime dependency for one check; the existing scripts in scripts/ have zero external dependencies by convention — a manual $value/$type presence check gets the same practical signal without the dependency" [ref=e215]:
            - cell "Validate tokens/*.json against DTCG's official JSON Schema via ajv" [ref=e216]:
              - text: Validate
              - code [ref=e217]: tokens/*.json
              - text: against DTCG's official JSON Schema via
              - code [ref=e218]: ajv
            - cell "Adds a new runtime dependency for one check; the existing scripts in scripts/ have zero external dependencies by convention — a manual $value/$type presence check gets the same practical signal without the dependency" [ref=e219]:
              - text: Adds a new runtime dependency for one check; the existing scripts in
              - code [ref=e220]: scripts/
          ...
          - 'row "Enforce one fixed set of required ## sections across every guidelines/components/*.md The 17 existing files do not share a single template today (e.g. tabs.md has no ## Intent; feature-card.md/icon.md/tabs.md/top-nav.md have no ## Governance) — enforcing this would invent a rule not actually in force, rather than check one that is. Only ## UX Patterns Reference is universal and explicitly mandated (ux-patterns-sources.md), so only that is checked" [ref=e223]':
            - 'cell "Enforce one fixed set of required ## sections across every guidelines/components/*.md" [ref=e224]':
              - text: Enforce one fixed set of required
              - code [ref=e225]: "##"
              - text: sections across every
              - code [ref=e226]: guidelines/components/*.md
            - 'cell "The 17 existing files do not share a single template today (e.g. tabs.md has no ## Intent; feature-card.md/icon.md/tabs.md/top-nav.md have no ## Governance) — enforcing this would invent a rule not actually in force, rather than check one that is. Only ## UX Patterns Reference is universal and explicitly mandated (ux-patterns-sources.md), so only that is checked" [ref=e227]':
              ...
              - text: has no
              - code [ref=e229]: "## Intent"
              - text: ;
              - code [ref=e230]: feature-card.md
              - text: /
              - code [ref=e231]: icon.md
              - text: /
              - code [ref=e232]: tabs.md
              - text: /
              - code [ref=e233]: top-nav.md
              - text: have no
              - code [ref=e234]: "## Governance"
              - text: ) — enforcing this would invent a rule not actually in force, rather than check one that is. Only
              - code [ref=e235]: "## UX Patterns Reference"
              - text: is universal and explicitly mandated (
              - code [ref=e236]: ux-patterns-sources.md
              - text: ), so only that is checked
          - row "A separate ADR for the En cours status-discipline rule Too small on its own (one line, no architectural weight) to warrant a dedicated ADR; bundled here since it was decided in the same session" [ref=e237]:
            - cell "A separate ADR for the En cours status-discipline rule" [ref=e238]:
              - text: A separate ADR for the
              - code [ref=e239]: En cours
              - text: status-discipline rule
            - cell "Too small on its own (one line, no architectural weight) to warrant a dedicated ADR; bundled here since it was decided in the same session" [ref=e240]
      - heading "Consequences" [level=2] [ref=e241]
      - list [ref=e242]:
        - listitem [ref=e243]:
          - code [ref=e244]: package.json
          - text: ":"
          - code [ref=e245]: relationships
          - text: and
          - code [ref=e246]: validate:contracts
          - text: scripts added;
          - code [ref=e247]: validate:contracts
      - paragraph [ref=e248]:
        - text: now runs as part of
        - code [ref=e249]: npm test
        - text: .
      - list [ref=e250]:
        - listitem [ref=e251]:
          - code [ref=e252]: .gitignore
          - text: ":"
          - code [ref=e253]: relationships-report.json
          - text: added (generated artifact, same convention as
      - paragraph [ref=e254]:
        - code [ref=e255]: audit-report.json
        - text: ).
      - list [ref=e256]:
        - listitem [ref=e257]:
          - code [ref=e258]: relationships-report.json
          - text: is not committed — regenerate on demand via
          - code [ref=e259]: npm run relationships
      - paragraph [ref=e260]: before any TCR impact assessment.
      - list [ref=e261]:
        - listitem [ref=e262]: No new runtime dependency added.
        - listitem [ref=e263]:
          - text: "GitHub Projects: both tickets moved to"
          - code [ref=e264]: En cours
          - text: (per the new status-discipline rule) when
      - paragraph [ref=e265]:
        - text: this work started, to be moved to
        - code [ref=e266]: Terminé
        - text: once this ADR merges.
      - list [ref=e267]:
        - listitem [ref=e268]:
          - code [ref=e269]: scripts/audit-tokens.js
          - text: is unaffected — its scope (code-layer drift) and this ADR's scope
      - paragraph [ref=e270]: (governance-layer contracts) are deliberately disjoint.
      - generic [ref=e271]:
        - link "← ADR-085" [ref=e272] [cursor=pointer]:
          - /url: adr-085.html
        - link "ADR-087 →" [ref=e273] [cursor=pointer]:
          - /url: adr-087.html
    - navigation "Table of contents / Table des matières" [ref=e274]:
      - generic [ref=e275]: On this page
      - link "Context" [ref=e276] [cursor=pointer]:
        - /url: "#context"
      - link "Decision" [ref=e277] [cursor=pointer]:
        - /url: "#decision"
      - link "Rejected alternatives" [ref=e278] [cursor=pointer]:
        - /url: "#rejected-alternatives"
      - link "Consequences" [ref=e279] [cursor=pointer]:
        - /url: "#consequences"
