...
across every commit it introduced, not after each individual commit — see
`pipelines/backlog.md` for why and `governance/rules/git-workflow.md`'s PR
checklist for where it's required.
