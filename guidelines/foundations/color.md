...
Levels:
1. Primitives: blue-700 (primitives.json)
2. Semantics: color.action.primary (semantic.json)
3. Components: button.primary.background (component.json)

Dark mode: only semantics are remapped.
