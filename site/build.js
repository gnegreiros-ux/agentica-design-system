...
.top-nav a{
  ...
  padding:0 14px;border-radius:0;font-weight:var(--agtc-semantic-typography-label-weight);
...
.top-nav a:focus-visible{outline:2px solid var(--agtc-semantic-color-border-focus);outline-offset:2px}
.top-nav a.active{background:transparent;color:var(--agtc-semantic-color-action-primary);font-weight:var(--agtc-semantic-fontWeight-bold);border-bottom-color:var(--agtc-semantic-color-action-primary)}
...
.top-nav a.nav-cta,.top-nav a.nav-cta.active{
  ...
  padding:6px 14px;border-radius:var(--agtc-semantic-radius-control);border-bottom:none;
  background:var(--agtc-semantic-color-action-primary);color:var(--agtc-semantic-color-text-on-action);
  font-weight:var(--agtc-semantic-typography-label-weight);margin-left:8px;
}
...
.top-nav a.nav-cta:active{background:var(--agtc-semantic-color-action-primary-hover);color:var(--agtc-semantic-color-text-on-action)}
