  ...
  <div class="footer-grid">
    <div class="footer-col">
      <a class="brand" href="${base}index.html" aria-label="Agentica — Accueil" style="margin-bottom:.5rem">
        <img src="${base}img/logo-color-white.svg" alt="Agentica" class="logo-dark" height="40" width="191" loading="lazy">
        <img src="${base}img/logo-color.svg" alt="" aria-hidden="true" class="logo-light" height="40" width="191" loading="lazy">
      </a>
...
<header class="site-header" role="banner" data-site-header>
  <a class="brand" href="${base}index.html" aria-label="Agentica — Accueil">
    <img src="${base}img/logo-color-white.svg" alt="Agentica" class="logo-dark" height="34" width="162" fetchpriority="high">
    <img src="${base}img/logo-color.svg" alt="" aria-hidden="true" class="logo-light" height="34" width="162" fetchpriority="high">
  </a>
