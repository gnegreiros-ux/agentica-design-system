...
[data-context="marketing"] .hero-content-w{
  ...
  border-radius:var(--agtc-space-4);
}
...
@media(max-width:860px){
  ...
  .rd-cinematic-body,.rd-cinematic-body-r,.rd-cinematic-body-wide{width:100%;max-width:none;margin:0;border-radius:var(--agtc-space-3)}
}
...
.ai-answer code{background:rgba(52,211,187,.12);color:var(--site-teal);padding:.1em .35em;border-radius:var(--agtc-space-1);font-size:.8rem}
...
.brief-block{border-radius:var(--agtc-space-3);overflow:hidden;background:var(--agtc-semantic-color-background-code);border:1px solid rgba(255,255,255,.08)}
