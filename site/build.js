...
/* Gradient bg-fade — tokens overlay.* remplacent les rgba hardcodés */
.rd-bg-fade{
  position:absolute;inset:0;
  background:linear-gradient(to right,
    var(--agtc-semantic-color-background-inverse) 0%,
    var(--agtc-semantic-color-overlay-dark) 28%,
    var(--agtc-semantic-color-overlay-medium) 52%,
    var(--agtc-semantic-color-overlay-subtle) 70%,
    transparent 90%
  );
}
...
/* Container texte — glassmorphism : fond sombre semi-transparent + verre dépoli.
   token overlay.scrim garantit la lisibilité WCAG AA du texte blanc sur illustration. */
.rd-cinematic-body{
...
@media(max-width:860px){
  ...
  .rd-cinematic-body,.rd-cinematic-body-r{width:100%;max-width:none;margin:0;border-radius:12px}
}
