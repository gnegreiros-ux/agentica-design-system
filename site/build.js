...
/* ── FOOTER ──────────────────────────────────────────────── */
.site-footer{background:var(--agtc-semantic-color-background-inverse);color:var(--agtc-semantic-color-text-on-dark-muted);padding:40px 32px;font-size:var(--agtc-semantic-typography-label-size);margin-top:auto}
...
.audit-footer-link{color:var(--agtc-semantic-color-text-on-dark-muted);text-decoration:none;font-size:var(--agtc-semantic-typography-detail-size);display:inline-flex;align-items:center;gap:4px;transition:color .12s}
...
/* Bleed — images du côté droit : du centre vers le bord droit */
.v2-overlap > figure:last-child,
.v2-immersive-grid > figure:last-child,
.v2-final-grid > figure:last-child{width:50vw;max-width:none;margin-right:calc(-1 * (100vw - var(--v2-shell)) / 2)}
/* Bleed — images du côté gauche : du bord gauche vers le centre */
.v2-split > figure:first-child,
.v2-overlap > figure:first-child{width:50vw;max-width:none;margin-left:calc(-1 * (100vw - var(--v2-shell)) / 2)}
.v2-immersive{
...
.v2-human-control{overflow-x:clip}
