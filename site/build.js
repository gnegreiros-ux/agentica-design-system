...
.pf-fcell:not(:last-child)::after{content:'→';position:absolute;right:-16px;top:50%;transform:translateY(-50%);font-size:1.8rem;color:var(--agtc-semantic-color-text-on-dark);padding:4px;z-index:2}
